...
def linestring_to_lanes(linestring: List[LineString]) -> ndarray[Any, dtype[Any]]:
    """
    ...
    for line in linestring:
        lane_points.append(line.coords[0])
...
class GenerateLaneLine(object):
    ...
    def __call__(self, sample: dict) -> dict:
        ...
        if self.training:
            ...
            sample_copy.update({'lanes': linestring_to_lanes(lns)})
