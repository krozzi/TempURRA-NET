...
from tempurranet.tempurra_global_registry import BACKBONES

"""borrowed from PyTorch docs"""
...
if __name__ == '__main__':
    import torch
    resnet = ResNetWrapper(resnet='resnet34', pretrained=True, replace_stride_with_dilation=[False, False, False], out_conv=False)
    with torch.no_grad():
        output = resnet(torch.randn(10, 3, 128, 256))
